...
import FreshmanComposition from "../../courses/english/FreshmanComposition.mdx";

import IntroductionToBiology from "../../courses/biology/IntroductionToBiology.mdx";
import CellBiology from "../../courses/biology/CellBiology.mdx";
